...
**邀请嘉宾** — 议题与进度、主持开场、嘉宾名单与核心立场、进入第一轮讨论

![邀请嘉宾](docs/screenshots/01-introduction.png)

**圆桌讨论** — 轮次标题、主持引导、嘉宾发言与简言之、可/深/止 推演走向

![圆桌讨论](docs/screenshots/02-chat.png)

**话题总结** — 知识网络已生成、核心定义跃迁、三大支柱、终极结论与操作按钮

![话题总结](docs/screenshots/03-summary.png)
